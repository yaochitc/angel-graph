...
public class PartGetTopkNeighborResult extends PartitionGetResult {
	private int partId;
	private NodeIDWeightPairs[] nodeIdsWeights;
	private static final int NullMark = 0;
	private static final int NotNullMark = 1;

	PartGetTopkNeighborResult(int partId, NodeIDWeightPairs[] nodeIdsWeights) {
		this.partId = partId;
		this.nodeIdsWeights = nodeIdsWeights;
	}

	public PartGetTopkNeighborResult() {
		this(-1, null);
	}
