...
import com.tencent.angel.graph.client.getfullneighbor.PartGetFullNeighborParam;
...
public class GetSortedFullNeighborParam extends GetParam {
	...
	public GetSortedFullNeighborParam(int matrixId, long[] nodeIds, int[] edgeTypes) {
		super(matrixId);
